        ...
        criptomonedas_valores_1.default.forEach(async (cripto) => {
            if (interaction.options.getSubcommand() === cripto.id) {
                ...
                try {
                    ...
                    let criptodolar = dataCoinGecko.prices;
                    const embed = new discord_js_1.default.EmbedBuilder()
                        ...
                        .addFields({ name: `Monto original  `, value: `${cripto.simbolo} ${convertir} ` }, { name: "Dólares :dollar: ", value: (0, formato_1.formatoPrecio)(((convertir * criptodolar)), "USD"), inline: true }, { name: "Compra :flag_ar: ", value: 'ARS' + (0, formato_1.formatoPrecio)(((cripto.id === "terraluna" ? ((convertir * criptodolar) * dataCriptoYa.bid) : convertir * dataCriptoYa.bid)), "ARS"), inline: true }, { name: "Venta :flag_ar: ", value: 'ARS' + (0, formato_1.formatoPrecio)(((cripto.id === "terraluna" ? ((convertir * criptodolar) * dataCriptoYa.bid) : convertir * dataCriptoYa.ask)), "ARS"), inline: true });
                    await wait(3000);
