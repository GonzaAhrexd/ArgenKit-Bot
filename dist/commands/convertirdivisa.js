...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('usd')
        .setDescription('Monto en Dólares.'))).addSubcommand(subcommand => subcommand.setName('euro')
        .setDescription('Convierte de Euros a Pesos Argentinos')
        .addStringOption(option => option.setName('eur')
        ...
        .addStringOption(option => option.setName('brl')
        ...
        .addStringOption(option => option.setName('jpy')
        ...
        .addStringOption(option => option.setName('gbp')
        ...
        .addStringOption(option => option.setName('rub')
        .setDescription('Monto en Rublos.')))
        .addSubcommand(subcommand => subcommand.setName('dolar_canadiense')
        .setDescription('Convierte de Dólares Canadianos a Pesos Argentinos')
        .addStringOption(option => option.setName('cad')
        .setDescription('Monto en Dólares Canadianos.')))
        .addSubcommand(subcommand => subcommand.setName('dolar_australiano')
        .setDescription('Convierte de Dólares Australianos a Pesos Argentinos')
        .addStringOption(option => option.setName('aud')
        .setDescription('Monto en Dólares Australianos.')))
        .addSubcommand(subcommand => subcommand.setName('dolar_neozelandes')
        .setDescription('Convierte de Dólares Neozelandeses a Pesos Argentinos')
        .addStringOption(option => option.setName('nzd')
        .setDescription('Monto en Dólares Neozelandeses.')))
        .addSubcommand(subcommand => subcommand.setName('peso_mexicano')
        .setDescription('Convierte de Pesos Mexicanos a Pesos Argentinos')
        .addStringOption(option => option.setName('mxn')
        .setDescription('Monto en Pesos Mexicanos.')))
        .addSubcommand(subcommand => subcommand.setName('peso_chileno')
        .setDescription('Convierte de Pesos Chilenos a Pesos Argentinos')
        .addStringOption(option => option.setName('clp')
        ...
        .addStringOption(option => option.setName('cop')
        ...
        .addStringOption(option => option.setName('uyu')
        ...
        .addStringOption(option => option.setName('bob')
        ...
        .addStringOption(option => option.setName('pen')
        ...
        .addStringOption(option => option.setName('pyg')
        ...
        .addStringOption(option => option.setName('vef')
        ...
        .addStringOption(option => option.setName('cny')
        ...
        .addStringOption(option => option.setName('inr')
        ...
        .addStringOption(option => option.setName('krw')
        ...
        .addStringOption(option => option.setName('chf')
