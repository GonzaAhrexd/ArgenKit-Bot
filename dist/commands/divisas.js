    ...
    run(client, interaction, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (interaction.options.getSubcommand() === 'dolar') {
                yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/dolar/oficial')
                    .then((oficial) => __awaiter(this, void 0, void 0, function* () {
                    yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/dolar/blue')
                        .then((blue) => __awaiter(this, void 0, void 0, function* () {
                        yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/dolar/bolsa')
                            .then((mep) => __awaiter(this, void 0, void 0, function* () {
                            yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/dolar/contadoliqui')
                                .then((ccl) => {
            ...
            if (interaction.options.getSubcommand() === 'euro') {
                yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/euro/oficial')
                    .then((oficial) => __awaiter(this, void 0, void 0, function* () {
                    yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/euro/blue')
                        .then((blue) => {
                        const embed1 = new Discord.MessageEmbed()
            ...
            if (interaction.options.getSubcommand() === 'real') {
                yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/real/oficial')
                    .then((oficial) => __awaiter(this, void 0, void 0, function* () {
                    yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/real/blue')
                        .then((blue) => {
                        const embed1 = new Discord.MessageEmbed()
            ...
            divisas.forEach((divisa) => __awaiter(this, void 0, void 0, function* () {
                if (interaction.options.getSubcommand() === divisa.id) {
                    yield axios.get('https://api.exchangerate.host/latest')
                        .then((DIVISA) => __awaiter(this, void 0, void 0, function* () {
                        yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/euro/oficial')
                            .then((oficial) => __awaiter(this, void 0, void 0, function* () {
                            yield axios.get('https://dolarbot-api.g0nz4codderar.repl.co/api/euro/blue')
                                .then((blue) => {
