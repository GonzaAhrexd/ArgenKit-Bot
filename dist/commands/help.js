    ...
    run(client, interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            collector.on("collect", (collected) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (value === "second") {
                    yield interaction.editReply({ embeds: [embed3], ephemeral: false });
                }
                if (value === "third") {
                    yield interaction.editReply({ embeds: [embed4], ephemeral: false });
                }
                if (value === "fourth") {
                    yield interaction.editReply({ embeds: [embed5], ephemeral: false });
                }
                if (value === "fifth") {
                    yield interaction.editReply({ embeds: [embed6], ephemeral: false });
                }
                if (value === "sixth") {
                    yield interaction.editReply({ embeds: [embed7], ephemeral: false });
                }
                if (value === "seventh") {
                    yield interaction.editReply({ embeds: [embed8], ephemeral: false });
                }
            }));
        });
    }
