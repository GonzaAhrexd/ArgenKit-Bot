...
module.exports = {
    ...
    async run(client, interaction) {
        ...
        let embed = new discord_js_1.default.EmbedBuilder()
            ...
            .setColor('#385E7F')
            .addFields({ name: "» Comandos disponibles", value: "¡Tenemos `6` categorías distintas llenas de comandos y subcomandos! \n Para ver las novedades más recientes del bot utiliza `/update`" }, { name: "» Comandos populares", value: "`impuesto`  `calcular`  `convertirdivisa dolar`  `divisa dolar`  `elecciones`  `servicio netflix`  `servicio twitch`  `servicio disney+`  `8ball`  `calcular`  `invite`" }, { name: "» Comandos nuevos", value: "`mercado`  `clima`  `juegos`  `frase``" }).setThumbnail("https://cdn.discordapp.com/attachments/802944543510495292/1176889247215648829/search_1.png?ex=65708286&is=655e0d86&hm=c0193aa9ccd9a045905e83e990940c81897d4c355da14866de45efd48a4a7e72&");
        let embed2 = new discord_js_1.default.EmbedBuilder()
            ...
            .addFields({ name: "» Utilidad ", value: "`impuesto`  `calcular`  `anualizarinflacion`  `traductor`  `hora`  `clima`" }, { name: "» `convertirdivisa`", value: "Subcomandos `dolar`  `euro`  `real`  `yen`  `libra`  `rublo`  `dolarcanadiense`  `dolaraustraliano`  `dolarneozelandes`  `pesomexicano`  `pesochileno`  `pesouruguayo`  `pesocolombiano`  `boliviano`  `sol`  `guarani`  `bolivar`  `yuan`  `rupia`  `won`  `franco`  `lira`" }, { name: "» `pesoa` ", value: "» Subcomandos `dolar`  `euro`  `real`  `yen`  `libra`  `rublo`  `dolarcanadiense`  `dolaraustraliano`  `dolarneozelandes`  `pesomexicano`  `pesochileno`  `pesouruguayo`  `pesocolombiano`  `boliviano`  `sol`  `guarani`  `bolivar`  `yuan`  `rupia`  `won`  `franco`  `lira`" }, { name: "» `convertircripto` ", value: "» Subcomandos `bitcoin`  `ethereum`  `tether`  `axieinfinity`  `terraluna`  `decentraland`  `solana`  `dai`  `dogecoin`  `litecoin` `cardano` `bnb` `usdcoin` `avalanche` `polkadot` `uniswap` `polygon` `tron`" }, { name: "» pesoacripto ", value: "» Subcomandos `bitcoin` `ethereum` `tether` `axieinfinity` `terraluna` `decentraland` `solana` `dai` `dogecoin` `litecoin` `cardano` `bnb` `usdcoin` `avalanche` `polkadot` `uniswap` `polygon` `tron`" }, { name: "» convertirmetal ", value: "» Subcomandos `oro` `plata` `paladio` `platino`" }, { name: "» pesoametal ", value: "» Subcomandos `oro` `plata` `paladio` `platino`" });
        let embed3 = new discord_js_1.default.EmbedBuilder()
            ...
            .addFields({ name: "» `divisa` ", value: "» Subcomandos `dolar`  `euro`  `real`  `yen`  `libra`  `rublo`  `dolarcanadiense`  `dolaraustraliano`  `dolarneozelandes`  `pesomexicano`  `pesochileno`  `pesouruguayo`  `pesocolombiano`  `boliviano`  `sol`  `guarani`  `bolivar`  `yuan`  `rupia`  `won`  `franco`  `lira`" }, { name: "» `criptomoneda` ", value: "» Subcomandos `bitcoin` `ethereum` `tether` `axieinfinity` `terraluna` `decentraland` `solana` `dai` `dogecoin` `litecoin` `cardano` `bnb` `usdcoin` `avalanche` `polkadot` `uniswap` `polygon` `tron`" }, { name: "» `metal`", value: "» Subcomandos `oro` `plata` `paladio` `platino`" }, { name: "» `mercado`", value: "» Subcomandos `estado` `acciones` `consultar`" });
        let embed4 = new discord_js_1.default.EmbedBuilder()
            ...
            .addFields({ name: "» Comando `datos`", value: "subcomandos `riesgopais`  `reservas`  `circulante`  `pbi`  `gabinete`" }, { name: "» Otros Comandos ", value: "`elecciones`  `futbol`  `provinciainfo`" });
        let embed5 = new discord_js_1.default.EmbedBuilder()
            ...
            .addFields({ name: "» `servicio`", value: "`netflix`  `youtube`  `spotify`  `crunchyroll`  `disney`  `xboxgamepass`  `primevideo`  `appletv`  `hbomax`  `discordnitro`  `googleone`  `ea`  `steam`  `paramount`  `twitch`" }, { name: "» `juegos`", value: "`minecraft`  `roblox`  `fortnite`  `leagueoflegends`  `valorant`  `counterstrike`  `clashroyale`  `clashofclans`  `genshinimpact`  `freefire`" });
        let embed6 = new discord_js_1.default.EmbedBuilder()
            ...
            .addFields({ name: "» Comandos", value: "`covidtest`  `escaparlatam`  `8ball`  `moneda`  `dados`  `frase`" });
        let embed7 = new discord_js_1.default.EmbedBuilder()
            ...
            .addFields({ name: "» Comandos", value: "`creador`  `api`  `invitar`  `servidor`  `votar`  `donaciones`  `update`" });
        const collector = interaction.channel.createMessageComponentCollector({
            componentType: discord_js_3.ComponentType.StringSelect, time: 30000
        });
