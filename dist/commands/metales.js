...
module.exports = {
    ...
    run(client, interaction, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Metales.forEach((Metal) => __awaiter(this, void 0, void 0, function* () {
                if (interaction.options.getSubcommand() === Metal.id) {
                    yield axios.get('https://api.metals.live/v1/spot/') //Precio en dólares
                        .then((precio) => __awaiter(this, void 0, void 0, function* () {
                        let conversion = 0;
                        if (Metal.id == 'oro')
