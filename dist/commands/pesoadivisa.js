...
// Variables
const divisas_valores_1 = __importDefault(require("../variables/divisas-valores")); //Divisas
...
module.exports = {
    data: new discord_js_1.default.SlashCommandBuilder()
        ...
        .addNumberOption(option => option.setName("ars")
        .setDescription("Monto en Pesos Argentinos.").setRequired(true)))
        .addSubcommand(subcommand => subcommand.setName("dolarnuevozelandes")
            ...
            if (interaction.options.getSubcommand() === divisa.id) {
                ...
                try {
                    ...
                    const embed = new discord_js_1.default.EmbedBuilder()
                        ...
                        .addFields({ name: "Monto Original :flag_ar:", value: 'ARS$ ' + (0, formato_1.formatoPrecio)(convertir, "ARS") }, 
                    //Oficial
                    { name: `${divisa.nombre} oficial :bank: `, value: `Valor del peso argentino expresado en ${divisa.nombre}`, inline: false }, { name: `Compra ${divisa.bandera}`, value: (0, formato_1.formatoPrecio)((convertir * aconvertir) / dolarData.oficial.value_buy, divisa.iso), inline: true }, { name: `Venta ${divisa.bandera}`, value: (0, formato_1.formatoPrecio)((convertir * aconvertir) / dolarData.oficial.value_sell, divisa.iso), inline: true });
                    await wait(3000);
