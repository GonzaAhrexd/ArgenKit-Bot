...
let slashcommandsFile = fs.readdirSync('src/commands').filter(file => (file.endsWith(".ts") || file.endsWith(".js")) && !file.endsWith(".d.ts"));
// Convierte los .ts a .js si está en modo producción 
if (process.env.mode === "production")
    slashcommandsFile = slashcommandsFile.map(file => {
        if (file.endsWith(".ts")) {
            return file.replace(".ts", ".js");
        }
        return file;
    });
let cantidadComandos = 0;
