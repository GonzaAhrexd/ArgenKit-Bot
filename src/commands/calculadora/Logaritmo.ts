...
const Logaritmo = async (client: any, interaction: any) => {
  ...
  const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
    ...
    .setColor("#97E4F9")
    .setThumbnail(
      "https://cdn.discordapp.com/attachments/802944543510495292/1181801184957300757/logarithm.png?ex=6582611f&is=656fec1f&hm=6158f0933a0f954db8abfae6376a603435c1ba931234923a62d8701d2f0b2b3f&",
    )
    .addFields(
