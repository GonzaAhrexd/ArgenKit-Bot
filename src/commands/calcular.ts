  ...
  data: new Discord.SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("simple")
        .setDescription(
          "Realiza una operación matemática escribiendo el cálculo a realizar como texto",
        )
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("indice")
            .setDescription("Indice de la raíz")
            .setRequired(true),
        )
        .addNumberOption((option) =>
          option
            .setName("radicando")
            .setDescription("Radicando de la raíz")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("base")
            .setDescription("Base de la potencia")
            .setRequired(true),
        )
        .addNumberOption((option) =>
          option
            .setName("exponente")
            .setDescription("Exponente de la potencia")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("base")
            .setDescription("Base del logaritmo")
            .setRequired(true),
        )
        .addNumberOption((option) =>
          option
            .setName("numero")
            .setDescription("Número del logaritmo")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("convertirbase")
        .setDescription("Convierte un número de una base a otra")
        .addNumberOption((option) =>
          option
            .setName("numero")
            .setDescription("Número a convertir")
            .setRequired(true),
        )
        .addNumberOption((option) =>
          option
            .setName("basedelnumero")
            .setDescription("Base del número a convertir")
            .setRequired(true),
        )
        .addNumberOption((option) =>
          option
            .setName("baseaconvertir")
            .setDescription("Base a la que se quiere convertir")
            .setRequired(true),
        ),
    ),
