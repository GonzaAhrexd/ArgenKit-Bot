    ...
    if (interaction.options.getSubcommand() === "consultar") {
      ...
      try {
        ...
        const embedClimaCiudad = new Discord.EmbedBuilder()
          ...
          .addFields(
            {
              name: "Temperatura :thermometer: ",
              value: `${weatherData.main.temp}°C`,
              inline: true,
            },
            {
              name: "Sensación térmica <:sensaciontermica:1182840701013201039> ",
              value: `${weatherData.main.feels_like}°C`,
              inline: true,
            },
            {
              name: `Estado ${emojiSegunMain(weatherData.weather[0].main)}`,
              value: `${mayusculaPrimerLetra(weatherData.weather[0].description)}`,
              inline: true,
            },
            {
              name: "Minima :arrow_down:",
              value: `${weatherData.main.temp_min}°C`,
              inline: true,
            },
            {
              name: "Maxima :arrow_up:",
              value: `${weatherData.main.temp_max}°C`,
              inline: true,
            },
            {
              name: "Humedad :bubbles:",
              value: `${weatherData.main.humidity}%`,
              inline: true,
            },
            {
              name: "Presión :stopwatch:",
