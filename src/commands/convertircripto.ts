    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("btc")
            .setDescription("Monto en Bitcoins.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("eth")
            .setDescription("Monto en Ethereum.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("usdt")
            .setDescription("Monto en Tether.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("axieinfinity")
        .setDescription("Convierte de Axie Infinity a Pesos Argentinos")
        .addNumberOption((option) =>
          option
            .setName("axs")
            .setDescription("Monto en Axie Infinity.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("decentraland")
        .setDescription("Convierte de Decentraland a Pesos Argentinos")
        .addNumberOption((option) =>
          option
            .setName("mana")
            .setDescription("Monto en Decentraland.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("sol")
            .setDescription("Monto en Solana.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("doge")
            .setDescription("Monto en Dogecoin.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("luna")
            .setDescription("Monto en Terra Luna 2.0.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("ltc")
            .setDescription("Monto en Litecoin.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("ada")
            .setDescription("Monto en Cardano.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("bnb")
            .setDescription("Monto en Binance Coin.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("usdc")
            .setDescription("Monto en USD Coin.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("avax")
            .setDescription("Monto en Avalanche.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("dot")
            .setDescription("Monto en Polkadot.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("uni")
            .setDescription("Monto en Uniswap.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("matic")
            .setDescription("Monto en Polygon.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      ...
      if (interaction.options.getSubcommand() === cripto.id) {
        ...
        try {
          ...
          const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
            ...
            .setDescription(
              `${cripto.nombre} expresado en pesos argentinos a la cotización del mercado`,
            )
            .setThumbnail(cripto.imagen)
            .addFields(
              {
                name: `Monto original  `,
                value: `${cripto.simbolo} ${convertir} `,
              },
              {
                name: "Dólares :dollar: ",
                value: formatoPrecio(convertir * criptodolar, "USD"),
                inline: true,
              },
              {
                name: "Compra :flag_ar: ",
                value:
                  ...
                  formatoPrecio(
                    cripto.id === "terraluna"
                      ? convertir * criptodolar * dataCriptoYa.bid
                      : convertir * dataCriptoYa.bid,
                    "ARS",
                  ),
                inline: true,
              },
