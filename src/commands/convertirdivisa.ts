                    ...
                    const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
                        ...
                        if(divisa.iso != "USD"){
                            embed.addFields(
                                ...
                                { name: `${divisa.nombre.toUpperCase()} <:rightarrow:921907270747570247> DÓLAR`, value: ` ${formatoPrecio(convertir / CONVERSION, "USD")} `, inline: true },
                            )
                        }    

                        embed.addFields(
                            { name: `${divisa.nombre} oficial :bank: `, value: `Valor del ${divisa.nombre} en pesos argentinos bajo esquema de flotación entre bandas. ` },
                            { name: "Compra :flag_ar: ", value: `ARS${formatoPrecio(((convertir / CONVERSION) * dolarData.oficial.value_buy), "ARS")}`, inline: true },
                            { name: "Venta :flag_ar: ", value: `ARS${formatoPrecio(((convertir / CONVERSION) * dolarData.oficial.value_sell), "ARS")}`, inline: true },
                            { name: "Impuestos nacionales", value: `Impuestos sobre tarjetas de crédito y débito a la compra de ${divisa.nombre}`, inline: false },
                            { name: "IVA (21%) ", value: `ARS${formatoPrecio(total21((convertir / CONVERSION) * dolarData.oficial.value_sell), "ARS")}`, inline: true },
                            { name: "Percepción de ganancias (30%) ", value: `ARS${formatoPrecio(total30((convertir / CONVERSION) * dolarData.oficial.value_sell), "ARS")}`, inline: true },
                            { name: "Percepción + IVA (51%) ", value: `ARS${formatoPrecio(total51((convertir / CONVERSION) * dolarData.oficial.value_sell), "ARS")}`, inline: true },
