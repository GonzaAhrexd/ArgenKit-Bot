            ...
            try {
                ...
                const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
                    ...
                    .addFields(
                        ...
                        //Impuestos
                        { name: "Impuestos (155%) ", value: `ARS${formatoPrecio(total60(convertir * oficial.data['venta']), "ARS")}`, inline: true },
                        //Blue
                ...
                try {
                    ...
                    const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
                        ...
                        .addFields(
                            ...
                            { name: "Impuestos (155%) ", value: `ARS${formatoPrecio(total60((convertir / aconvertir) * oficial.data['venta']), "ARS")}`, inline: true },
                            //Blue
