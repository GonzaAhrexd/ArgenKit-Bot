    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("xau")
            .setDescription("Monto en onza de Oro")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("xag")
            .setDescription("Monto en onza de Plata")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("xpt")
            .setDescription("Monto en onza de Platino.")
            .setRequired(true),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("xpd")
            .setDescription("Monto en onza de Paladio")
            .setRequired(true),
        ),
    ),
      ...
      if (interaction.options.getSubcommand() === Metal.id) {
        ...
        try {
          ...
          const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
            ...
            .addFields(
              {
                name: `Monto Original ${Metal.emoji}`,
                value: `${Metal.iso} ${currencyFormatter.format(convertir, { locale: "es-ES", code: " " })}`,
              },
              //Oficial
              {
                name: `${Metal.nombre} a precio del dólar oficial :bank: `,
                value: `Valor del ${Metal.nombre} a precio del dólar oficial, liquidado por parte del gobierno nacional sujeto a diversos impuestos `,
              },
              {
                name: "Compra :flag_ar: ",
                value: `ARS${formatoPrecio((convertir / metalData) * dolarData.oficial.value_buy, "ARS")}`,
                inline: true,
              },
              {
                name: "Venta :flag_ar: ",
                value: `ARS${formatoPrecio((convertir / metalData) * dolarData.oficial.value_sell, "ARS")}`,
                inline: true,
              },
            );
          await wait(4000);
