  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("circulante")
        .setDescription(
          "Muestra la cantidad de pesos circulantes en la economía",
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("basemonetaria")
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("inflacion")
        .setDescription(
          "Muestra el Indice de Precios al Consumidor del último mes registrado y comparaciones previas",
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
