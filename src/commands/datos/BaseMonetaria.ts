...
const baseMonetaria = async (
  ...
  const embed: EmbedBuilder = new EmbedBuilder()
    ...
    .setColor("#FAD56F")
    .setThumbnail(
      "https://cdn.discordapp.com/attachments/802944543510495292/1177083051579293696/profits.png?ex=65713704&is=655ec204&hm=7e73a87fbc7549b29a236a1b60cb97a45f421eb3ca79d284109a5694d902a7df&",
    )
    .addFields({
      name: "Valor  :bank: ",
      value: `${formatoPrecio(baseMonetariaData.baseMonetariaValor * 1000000, "ARS")} (${baseMonetariaData.fecha}) ${baseMonetariaData.isAumentoBase}`,
    });
