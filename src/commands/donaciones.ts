...
module.exports = {
  ...
  async run(client, interaction) {
    const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
      ...
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/1177084481941819463/donation.png?ex=65713859&is=655ec359&hm=3b3b29bd93898b5b38e44b00909be4bdfa5bfb46ce59248f75b50ea7e78d833b&",
      )
      .addFields(
        ...
        },
        {
          name: "Uala (Dólares)",
          value:
            "CBU (Dólares): 3840200500000016716081 \n Alias: RUINA.COLUMBRA.BALDE",
        },
      );
