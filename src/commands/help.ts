...
module.exports = {
  ...
  async run(client, interaction) {
        ...
        .addOptions([
          {
            ...
            description:
              "Estos comandos contienen utilidades y conversión de divisas ",
            value: "first",
      ...
      .addFields(
        {
          ...
          value:
            "¡Tenemos `6` categorías distintas llenas de comandos y subcomandos! \n Para ver las novedades más recientes del bot utiliza `/update`",
        },
        {
          name: "» Comandos populares",
          value:
            "`impuesto`  `calcular`  `convertirdivisa dolar`  `divisa dolar`  `elecciones`  `servicio netflix`  `servicio twitch`  `servicio disney+`  `8ball`  `calcular`  `invite`",
        },
        {
          name: "» Comandos nuevos",
          value: "`mercado`  `clima`  `juegos`  `frase``",
        },
      )
      .setThumbnail(
    ...
    let embed2 = new Discord.EmbedBuilder()
      ...
      .setColor("#385E7F")
      .setDescription(
        "Estos comandos contienen utilidades y conversión de divisa",
      )
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/903010091756814356/money-exchange.png",
      )
      .addFields(
        {
          name: "» Utilidad ",
          value:
            "`impuesto`  `calcular`  `anualizarinflacion`  `traductor`  `hora`  `clima`",
        },
        {
          name: "» `convertirdivisa`",
          value:
            "Subcomandos `dolar`  `euro`  `real`  `yen`  `libra`  `rublo`  `dolarcanadiense`  `dolaraustraliano`  `dolarneozelandes`  `pesomexicano`  `pesochileno`  `pesouruguayo`  `pesocolombiano`  `boliviano`  `sol`  `guarani`  `bolivar`  `yuan`  `rupia`  `won`  `franco`  `lira`",
        },
        {
          name: "» `pesoa` ",
          value:
        ...
        },
        {
          ...
          value:
            "» Subcomandos `bitcoin`  `ethereum`  `tether`  `axieinfinity`  `terraluna`  `decentraland`  `solana`  `dai`  `dogecoin`  `litecoin` `cardano` `bnb` `usdcoin` `avalanche` `polkadot` `uniswap` `polygon` `tron`",
        },
        {
          name: "» pesoacripto ",
          value:
        ...
        {
          name: "» convertirmetal ",
          value: "» Subcomandos `oro` `plata` `paladio` `platino`",
        },
        {
          name: "» pesoametal ",
          value: "» Subcomandos `oro` `plata` `paladio` `platino`",
    ...
    let embed3 = new Discord.EmbedBuilder()
      ...
      .setColor("#385E7F")
      .setDescription(
        "Estos comandos contienen distintas cotizaciones de divisas, criptomonedas, metales, o acciones financieras",
      )
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/90301281.759495484/dollars.png",
      )
      .addFields(
        {
          name: "» `divisa` ",
        ...
        {
          name: "» `mercado`",
          value: "» Subcomandos `estado` `acciones` `consultar`",
        },
      );
    ...
    let embed4 = new Discord.EmbedBuilder()
      ...
      .setColor("#385E7F")
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/903094616071483392/unknown.png",
      )
      ...
      .addFields(
        {
          name: "» Comando `datos`",
          value:
            "subcomandos `riesgopais`  `reservas`  `circulante`  `pbi`  `gabinete`",
        },
        {
          name: "» Otros Comandos ",
    ...
    let embed5 = new Discord.EmbedBuilder()
      ...
      .setColor("#385E7F")
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/903093667911315557/Servicios.png",
      )
      .setDescription(
        "Estos subcomandos te dan el precio de distintos servicios digitales en Argentina con impuestos",
      )
      .addFields(
        {
          name: "» `servicio`",
          value:
            "`netflix`  `youtube`  `spotify`  `crunchyroll`  `disney`  `xboxgamepass`  `primevideo`  `appletv`  `hbomax`  `discordnitro`  `googleone`  `ea`  `steam`  `paramount`  `twitch`",
        },
        {
          name: "» `juegos`",
          value:
    ...
    let embed6 = new Discord.EmbedBuilder()
      ...
      .setColor("#385E7F")
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/903094465747648552/Diversion.png",
      )
      .setDescription(
        "Estos son comandos con cosas divertidas mayormente basadas en aleatoridad",
      )
      .addFields({
        name: "» Comandos",
        value:
    ...
    let embed7 = new Discord.EmbedBuilder()
      ...
      .setColor("#385E7F")
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/903095489719828541/Informacion_del_bot.png",
      )
      .setDescription(
        "Estos comandos te permiten consultar más información acerca del bot",
      )
      .addFields({
        name: "» Comandos",
        value:
