...
module.exports = {
    ...
    async run(client, interaction){
      ...
      let embed = new Discord.MessageEmbed()
        ...
        .addField("» Comandos populares", "`impuesto`  `calcuar`  `convertir dolar`  `divisa dolar`  `divisa blue`  `elecciones`  `servicio netflix`  `servicio twitch`  `servicio disney+`  `8ball`  `moneda`  `invite`")
        .addField("» Comandos nuevos", "`calcular`  `hora`")
      ...
      let embed2 = new Discord.MessageEmbed()
        ...
        .addField("» Utilidad ", "`impuesto`  `calcular`  `anualizarinflacion`  `traductor`  `hora`")
        .addField("» `convertirdivisa`", "Subcomandos `dolar`  `euro`  `real`  `yen`  `libra`  `rublo`  `dolarcanadiense`  `dolaraustraliano`  `dolarneozelandes`  `pesomexicano`  `pesochileno`  `pesouruguayo`  `pesocolombiano`  `boliviano`  `sol`  `guarani`  `bolivar`  `yuan`  `rupia`  `won`  `franco`  `lira`")
        .addField("» `pesoa` ", "» Subcomandos `dolar`  `euro`  `real`  `yen`  `libra`  `rublo`  `dolarcanadiense`  `dolaraustraliano`  `dolarneozelandes`  `pesomexicano`  `pesochileno`  `pesouruguayo`  `pesocolombiano`  `boliviano`  `sol`  `guarani`  `bolivar`  `yuan`  `rupia`  `won`  `franco`  `lira`")
      ...
      let embed3 = new Discord.MessageEmbed()
        ...
        .addField("» `divisa` ", "» Subcomandos `dolar`  `euro`  `real`  `yen`  `libra`  `rublo`  `dolarcanadiense`  `dolaraustraliano`  `dolarneozelandes`  `pesomexicano`  `pesochileno`  `pesouruguayo`  `pesocolombiano`  `boliviano`  `sol`  `guarani`  `bolivar`  `yuan`  `rupia`  `won`  `franco`  `lira`")
