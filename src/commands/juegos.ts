  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .setDescription(
          "Muestra el precio de microtransacciones de League of Legends",
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("clashroyale")
        .setDescription(
          "Muestra el precio de microtransacciones de Clash Royale",
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .setDescription(
          "Muestra el precio de microtransacciones de Clash of Clans",
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("brawlstars")
        .setDescription(
          "Muestra el precio de microtransacciones de Brawl Stars",
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .setDescription(
          "Muestra el precio de microtransacciones de Genshin Impact",
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
