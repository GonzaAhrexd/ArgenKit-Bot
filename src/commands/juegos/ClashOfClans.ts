...
const ClashOfClans = async (
  ...
  const createClashOfClansEmbed = (withPerception: boolean) => {
    const embedClashOfClans = new EmbedBuilder()
      ...
      .setDescription(
        `Los precios en Clash of Clans en Argentina son los siguientes:`,
      )
      .setColor("#FFF956")
      .setThumbnail(
        "https://play-lh.googleusercontent.com/LByrur1mTmPeNr0ljI-uAUcct1rzmTve5Esau1SwoAzjBXQUby6uHIfHbF9TAT51mgHm=w240-h480-rw",
      );
