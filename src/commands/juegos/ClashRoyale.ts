...
const ClashRoyale = async (
  ...
  const createClashRoyaleEmbed = (withPerception: boolean) => {
    const embedClashRoyale = new EmbedBuilder()
      .setTitle("Clash Royale")
      .setURL("https://clashroyale.com/es")
      .setDescription(
        `Los precios en Clash Royale en Argentina son los siguientes:`,
      )
      .setColor("#57EAFF")
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/1181063385966723112/image.png?ex=657fb1fe&is=656d3cfe&hm=77fa2f583d85f9c4b6290adfa300c6fc4d49af6b199d7fe141c1b3c44bbde4a4&",
      );
