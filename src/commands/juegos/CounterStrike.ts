...
const CounterStrike = async (client: any, interaction: any) => {
  ...
  const crearEmbed = (conPercepcion: boolean) => {
    ...
    return new Discord.EmbedBuilder()
      ...
      .setDescription(
        "Los precios en Counter Strike 2 en Argentina son los siguientes:",
      )
      .setColor("#FBAC18")
      .setThumbnail(
        "https://static.wikia.nocookie.net/logopedia/images/4/49/Counter-Strike_2_%28Icon%29.png/revision/latest/scale-to-width-down/150?cb=20230330015359",
      )
      .addFields(
        {
          name: "Counter Strike 2 Status Prime",
          value: `ARS ${formatoPrecio(precio(14.99), "ARS")}`,
          inline: true,
        },
        {
          name: "Llaves para abrir cajas",
          value: `ARS ${formatoPrecio(precio(2.49), "ARS")}`,
          inline: true,
        },
      );
  };
