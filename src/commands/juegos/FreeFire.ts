...
const FreeFire = async (
  ...
  const createFreeFireEmbed = (withPerception: boolean) => {
    const embedFreeFire = new EmbedBuilder()
      .setTitle("Free Fire")
      .setURL("https://www.freefiremobile.com/es/")
      .setDescription(
        `Los precios en Free Fire en Argentina son los siguientes:`,
      )
      .setColor("#E87914")
      .setThumbnail(
