...
const GenshinImpact = async (client: any, interaction: any) => {
  ...
  const crearEmbedGenshin = (conPercepcion: boolean) => {
    const embed = new Discord.EmbedBuilder()
      ...
      .setColor("#7997D3")
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/802944543510495292/1181053245804773386/image.png?ex=657fa88c&is=656d338c&hm=ec2dcfd2f9ad4898c65d3b344684da67cdf324916f13c2fabaa5308663a1b4b0&",
      )
      .addFields(
        {
          name: "Pase",
          value: `ARS ${formatoPrecio(calcularPrecio(9.99, conPercepcion), "ARS")}`,
          inline: true,
        },
        {
          name: "Pase 10 niveles",
          value: `ARS ${formatoPrecio(calcularPrecio(19.99, conPercepcion), "ARS")}`,
          inline: true,
        },
        {
          name: "Bendición de la Luna",
          value: `ARS ${formatoPrecio(calcularPrecio(4.99, conPercepcion), "ARS")}`,
          inline: true,
        },
        {
          name: "60 Cristales",
          value: `ARS ${formatoPrecio(calcularPrecio(0.99, conPercepcion), "ARS")}`,
          inline: true,
        },
        {
          name: "300 Cristales",
        ...
        {
          name: "980 Cristales",
          value: `ARS ${formatoPrecio(calcularPrecio(14.99, conPercepcion), "ARS")}`,
          inline: true,
        },
        {
          name: "1980 Cristales",
          value: `ARS ${formatoPrecio(calcularPrecio(29.99, conPercepcion), "ARS")}`,
          inline: true,
        },
        {
          name: "3280 Cristales",
          value: `ARS ${formatoPrecio(calcularPrecio(49.99, conPercepcion), "ARS")}`,
          inline: true,
        },
        {
          name: "6480 Cristales",
          value: `ARS ${formatoPrecio(calcularPrecio(99.99, conPercepcion), "ARS")}`,
          inline: true,
        },
      );
  ...
  collector.on("collect", async (i) => {
    ...
    await i.editReply({
      embeds: [crearEmbedGenshin(conPercepcion)],
      components: [row],
    });
  });
};
