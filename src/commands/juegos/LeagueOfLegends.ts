...
const leagueoflegends = async (
  ...
  const llenarEmbed = (embed: EmbedBuilder, forma: string) => {
    ...
    embed.setDescription(
      `Los precios de RP en League of Legends con ${forma} en Argentina son los siguientes:`,
    );
    embed.setColor("#000082");
    embed.setThumbnail(
      "https://static.wikia.nocookie.net/leagueoflegendsoficial/images/8/8c/LOL_Logo.png/revision/latest?cb=20180119195439&path-prefix=es",
    );
  };
  ...
  embedTJ.addFields(
    {
      name: "235 RP + 0 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 3.99), "ARS"),
      inline: true,
    },
    {
      name: "645 RP + 45 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 10.99), "ARS"),
      inline: true,
    },
    {
      name: "1235 RP + 130 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 20.99), "ARS"),
      inline: true,
    },
    {
      name: "2060 RP + 315 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 34.99), "ARS"),
      inline: true,
    },
    {
      name: "3535 RP + 715 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 59.99), "ARS"),
      inline: true,
    },
    {
      name: "5300 RP + 1450 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 89.99), "ARS"),
      inline: true,
    },
  );
  ...
  embedPP.addFields(
    ...
    {
      name: "7360 RP + 2540 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 124.99), "ARS"),
      inline: true,
    },
  );
  ...
  embedPPal.addFields(
    ...
    {
      name: "7150 RP + 1350 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 59.99), "ARS"),
      inline: true,
    },
    {
      name: "10725 RP + 2775 RP",
      value: "ARS" + formatoPrecio(total21(valorDolar * 89.99), "ARS"),
      inline: true,
    },
  );
