        ...
        if (interaction.options.getSubcommand() === 'estado') {
            ...
            try {
                ...
                const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
                    ...
                    .addFields(
                        { name: 'Feriado ', value: ` ${estadoMercado.holiday == null ? "Ninguno" : estadoMercado.holiday}` },
                        { name: "Estado", value: estadoMercado.isOpen? "Abierto" : "Cerrado" },
                        { name: "Sesión", value: `${estadoMercado.session == null ? "Ninguno" : estadoMercado.session}` },
                    )
                    await wait(3000)
        ...
        if (interaction.options.getSubcommand() === 'consultar') {
            ...
            try {
                ...
                const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
                    ...
                    .addFields(
                        { name: "Precio actual", value: `${formatoPrecio(activoValores.currentPrice,"USD")}\nARS${formatoPrecio(activoValores.currentPrice*dolarMep.venta,"ARS")}`, inline: true },
                        { name: "Precio anterior", value: `${formatoPrecio(activoValores.previousClosePrice,"USD")}\nARS${formatoPrecio(activoValores.previousClosePrice*dolarMep.venta,"ARS")}`, inline: true },
                        { name: "Variación anterior", value: `${formatoNum(activoValores.percentChange)}% ${subioPrecio(activoValores)}`, inline: true },
                        { name: "Precio de apertura", value: `${formatoPrecio(activoValores.openPriceOfDay,"USD")}\nARS${formatoPrecio(activoValores.openPriceOfDay*dolarMep.venta,"ARS")}`, inline: true },
                        { name: "Precio más bajo del día", value: `${formatoPrecio(activoValores.lowPriceOfDay,"USD")}\nARS${formatoPrecio(activoValores.lowPriceOfDay*dolarMep.venta,"ARS")}`, inline: true },
                        { name: "Precio más alto del día", value: `${formatoPrecio(activoValores.highPriceOfDay,"USD")}\nARS${formatoPrecio(activoValores.highPriceOfDay*dolarMep.venta,"ARS")}`, inline: true },
                        )
                await wait(3000)
                await interaction.editReply({ embeds: [embed] });
