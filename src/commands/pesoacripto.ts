      ...
      if (interaction.options.getSubcommand() === cripto.id) {
        ...
        try {
          ...
          const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
            ...
            .setDescription(
              `Pesos argentinos expresado en ${cripto.nombre} a la cotización del mercado`,
            )
            ...
            .addFields(
              ...
              },
              {
                ...
                value:
                  ...
                  " " +
                  (cripto.id === "terraluna"
                    ? (convertir / criptodolar / dataCriptoYa.bid).toFixed(8)
                    : (convertir / dataCriptoYa.bid).toFixed(8)),
                inline: true,
              },
              {
                name: "Venta :flag_ar: ",
                value:
                  ...
                  " " +
                  (cripto.id === "terraluna"
                    ? (convertir / criptodolar / dataCriptoYa.ask).toFixed(8)
                    : (convertir / dataCriptoYa.ask).toFixed(8)),
                inline: true,
              },
            );
