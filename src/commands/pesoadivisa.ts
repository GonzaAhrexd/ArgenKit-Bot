      ...
      try {
        ...
        const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
          ...
          .addFields(
            ...
            //Impuestos
            { name: "Impuestos (155%)  ", value: formatoPrecio(restar60(convertir / oficial.data['venta']), "USD"), inline: true },
      ...
      try {
        ...
        const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
          ...
          .addFields(
            ...
            //Impuestos
            { name: "Impuestos (155%)  ", value: "EUR€ " + formatoPrecio(restar60(convertir / oficial.data['venta']), "EUR"), inline: true },
        ...
        try {
          ...
          const embed: Discord.EmbedBuilder = new Discord.EmbedBuilder()
            ...
            .addFields(
              ...
              //Impuestos
              { name: "Impuestos (155%)  ", value: `${divisa.iso} ${divisa.simbolo}` + formatoPrecio(restar60((convertir * aconvertir) / oficial.data['venta']), divisa.iso), inline: true },
