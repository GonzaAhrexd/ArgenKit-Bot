  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("dolar")
        .setDescription(
          "Convierte de  Pesos Argentinos a Dólares Estadounidenses",
        )
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("dolarnuevozelandes")
        .setDescription(
          "Convierte de Pesos Argentinos a Dólares Nuevos Zelandaes",
        )
        .addNumberOption((option) =>
          option
            .setName("ars")
      ...
      if (interaction.options.getSubcommand() === divisa.id) {
        ...
        try {
          ...
          const embed: EmbedBuilder = new EmbedBuilder()
            ...
            .addFields(
              {
                name: "Monto Original :flag_ar:",
                value: "ARS$ " + formatoPrecio(convertir, "ARS"),
              },

              //Oficial
              {
                name: `${divisa.nombre} oficial :bank: `,
                value: `Valor del peso argentino expresado en ${divisa.nombre}`,
                inline: false,
              },
              {
                name: `Compra ${divisa.bandera}`,
                value: formatoPrecio(
                  (convertir * aconvertir) / dolarData.oficial.value_buy,
                  divisa.iso,
                ),
                inline: true,
              },
              {
                name: `Venta ${divisa.bandera}`,
                value: formatoPrecio(
                  (convertir * aconvertir) / dolarData.oficial.value_sell,
                  divisa.iso,
                ),
                inline: true,
              },
