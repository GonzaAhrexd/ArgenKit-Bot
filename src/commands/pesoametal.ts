                        ...
                        axios.get('https://dolarapi.com/v1/dolares/blue'),
                                        ...
                                        const embed:Discord.EmbedBuilder = new Discord.EmbedBuilder()
                                            ...
                                            .addFields(
                                                ...
                                                //Impuestos
                                                {name:"Impuestos (60%)  ", value:`${Metal.iso} ` + currencyFormatter.format(restar60((convertir *  metal.data['usd'][Metal.iso]) / oficial.data['venta']), { locale:'es-ES', code:' ', precision:8}), inline:true},
