            ...
            .addFields(
              {
                ...
                value:
                  `ARS$ ` +
                  currencyFormatter.format(convertir, {
                    locale: "es-ES",
                    code: " ",
                  }),
                inline: false,
              },
              {
                ...
                value:
                  ...
                  currencyFormatter.format(
                    (convertir * metalData) / dolarData.oficial.value_buy,
                    { locale: "es-ES", code: " ", precision: 8 },
                  ),
                inline: true,
              },
              {
                ...
                value:
                  `${Metal.iso} ` +
                  currencyFormatter.format(
                    (convertir * metalData) / dolarData.oficial.value_sell,
                    { locale: "es-ES", code: " ", precision: 8 },
                  ),
                inline: true,
              },
