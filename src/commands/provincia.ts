      ...
      ubicacionImg: string,
        ...
        { identificacion: "caba",
         nombre: "Ciudad Autonoma de Buenos Aires (CABA)",
          color: "#FCFCFC", 
          bandera: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Bandera_de_la_Ciudad_de_Buenos_Aires.svg/662px-Bandera_de_la_Ciudad_de_Buenos_Aires.svg.png",
          url: "https://es.wikipedia.org/wiki/Provincia_de_Tucum%C3%A1n", 
          descripcion: "Buenos Aires, capital cosmopolita de Argentina, destaca por la Plaza de Mayo, la Casa Rosada, el Teatro Colón y el museo MALBA. Cedida por la Provincia en 1880, se convirtió en la capital federal y cuenta con autonomía desde la reforma constitucional de 1994.", gobernador: "Jorge Macri (JxC🟡)",
          ...
          ubicacion: "https://www.google.com.ar/maps/place/Buenos+Aires,+CABA/data=!4m2!3m1!1s0x95bcca3b4ef90cbd:0xa0b3812e88e88e87?sa=X&ved=2ahUKEwjsvqSxgpDxAhVPlJUCHdk6AQIQ8gEwJnoECGgQAQ", ubicacionDesc: "Su tejido urbano se asemeja a un abanico que limita al sur, oeste y norte con la lindante Provincia de Buenos Aires y al este con el Río de la Plata. Oficialmente la ciudad se encuentra dividida en 15 comunas que agrupan a 48 barrios.", 
        ...
        { identificacion: "buenos aires",
          ...
          color: "#0b67ff", 
          bandera: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Bandera_de_la_Provincia_de_Buenos_Aires.svg/1280px-Bandera_de_la_Provincia_de_Buenos_Aires.svg.png", url: "https://es.wikipedia.org/wiki/Provincia_de_Buenos_Aires", 
        ...
        { identificacion: "catamarca", 
          ...
          descripcion: "Catamarca, provincia en el noroeste de Argentina, tiene como capital a San Fernando del Valle de Catamarca. Su economía diversa se centra en minería, industria, comercio, turismo, ganadería y agricultura. Ocupa el puesto 12 en desarrollo humano entre las provincias argentinas.  ", 
        ...
        { identificacion: "chaco", 
          ...
          descripcion: "Chaco, en el noreste de Argentina, con Resistencia como capital, destaca por su agricultura (algodón, soja), ganadería y madera. Tiene una gran población indígena y una mezcla diversa de descendientes de varios países.", 
          gobernador: "Leandro Zdero  (JxC🟡)", 
          capital: "Resistencia", 
