...
const crearEmbed = (conPercepciones: boolean) => {
  ...
  return new Discord.EmbedBuilder()
    ...
    .addFields(
      {
        name: "Básico:",
        value: "ARS" + formatoPrecio(calcular(8999), "ARS"),
        inline: true,
      },
      {
        name: "Estándar:",
        value: "ARS" + formatoPrecio(calcular(14999), "ARS"),
        inline: true,
      },
      {
        name: "Premium:",
        value: "ARS" + formatoPrecio(calcular(19999), "ARS"),
        inline: true,
      },
      {
        name: "Casa extra:",
        value: "ARS" + formatoPrecio(calcular(4299), "ARS"),
        inline: true,
      },
    );
};
