...
const netflix = async (client: any, interaction: Discord.CommandInteraction) => {
    ...
    .addFields(
      { name: "Básico:", value: "ARS" + formatoPrecio(total51(7199), "ARS"), inline: true },
      { name: "Estándar:", value: "ARS" + formatoPrecio(total51(11999), "ARS"), inline: true },
      { name: "Premium:", value: "ARS" + formatoPrecio(total51(15999), "ARS"), inline: true },
      { name: "Casa extra:", value: "ARS" + formatoPrecio(total51(42999), "ARS"), inline: true }
    )
